...
//    public static final int PERMISSIONS_FILE_TAMPERED = 3;
    ...
    public int startup(String _ksFileName,
        ...
        //
        try{
            FileInputStream fis = new FileInputStream(_ksFileName);
            KeyStore caKeyStore = KeyStore.getInstance("JKS");
            caKeyStore.load(fis,_privateKeyPass);
            caKey = (PrivateKey)caKeyStore.getKey("ca",_privateKeyPass);
            getOutputArea().append("Loaded private key.\n");

            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("username.list")));
            String username;
            int i = 0;
            ...
            getOutputArea().append("Loaded "+i+" users.\n");
        } catch(Exception e){
    ...
    public Boolean addUsername(String username){
        ...
        usernames.add(username);
        try{
            PrintWriter pw = new PrintWriter(new FileOutputStream("username.list"));
